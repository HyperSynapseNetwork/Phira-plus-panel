          ...
          <dl class="mt-4 space-y-3 text-sm">
            <div>
              <dt class="text-xs text-muted">
                {{ t('users.phiraId') }}
              </dt><dd class="mt-0.5 font-mono text-foreground">
                {{ selectedUser.phira_id }}
              </dd>
            </div>
            <div>
              <dt class="text-xs text-muted">
                {{ t('users.ppbUuid') }}
              </dt><dd class="mt-0.5 break-all font-mono text-xs text-foreground">
                {{ selectedUser.ppb_user_id }}
              </dd>
            </div>
            <div>
              <dt class="text-xs text-muted">
                {{ t('users.status') }}
              </dt><dd class="mt-0.5 text-foreground">
                {{ userStatusLabel(t, selectedUser.status) }}
              </dd>
            </div>
            <div>
              <dt class="text-xs text-muted">
                ...
                {{ formatDateTime(selectedUser.last_seen_at ?? undefined) }}
              </dd>
            </div>
          </dl>
